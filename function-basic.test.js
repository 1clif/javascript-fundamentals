describe("Function basic", () => {
  it("Should be function declarations", () => {
    function declaration(){ return "I am a function declarations";}
    expect(declaration()).toBe("I am a function declarations");
  });
  ...
  it("Should be function expression", () => {
    ...
    expect(a()).toBe("I am a function expression");
  });
  ...
  test("Should get arguments length", () => {
    ...
    function withoutArguments(){ return arguments.length;}
    function withOneArgument(a){ return arguments.length;}
    function withTwoArguments(b,c){ return arguments.length;}
